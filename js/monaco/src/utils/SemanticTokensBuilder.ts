import { IRange, languages, Range as MonacoRange } from 'monaco-editor';
...
function isStringArray(value: unknown): value is string[] {
    return Array.isArray(value) && (value as unknown[]).every((elem) => isString(elem));
}
...
export class SemanticTokensBuilder {
    ...
    constructor(legend?: languages.SemanticTokensLegend) {
        this._prevLine = 0;
        this._prevChar = 0;
    ...
    public push(arg0: any, arg1: any, arg2: any, arg3?: any, arg4?: any): void {
        ...
        if (MonacoRange.isIRange(arg0) && typeof arg1 === 'string' && isStrArrayOrUndefined(arg2)) {
            // 2nd overload
    ...
    private _push(range: IRange, tokenType: string, tokenModifiers?: string[]): void {
        if (!this._hasLegend) {
    ...
    public build(resultId?: string): languages.SemanticTokens {
