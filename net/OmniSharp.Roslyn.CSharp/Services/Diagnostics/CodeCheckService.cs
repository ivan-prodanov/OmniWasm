...
namespace OmniSharp.Roslyn.CSharp.Services.Diagnostics
{
    ...
    public class CodeCheckService : IRequestHandler<CodeCheckRequest, CodeCheckResponse>
    {
        ...
        public async Task<CodeCheckResponse> Handle(CodeCheckRequest request)
        {
        ...
        private static CodeCheckResponse GetResponseFromDiagnostics(ImmutableArray<DocumentDiagnostics> diagnostics, string fileName)
        {
            ...
            return new CodeCheckResponse(diagnosticLocations);
        }
    }
}
