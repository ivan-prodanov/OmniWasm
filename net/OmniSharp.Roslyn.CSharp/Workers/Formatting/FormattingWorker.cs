...
namespace OmniSharp.Roslyn.CSharp.Workers.Formatting
{
    ...
    {
        public static async Task<IEnumerable<LinePositionSpanTextChange>> GetFormattingChangesAfterKeystroke(Document document, int position, char character, bool formatOpenBracket, OmniSharpOptions omnisharpOptions, ILoggerFactory loggerFactory)
        {
